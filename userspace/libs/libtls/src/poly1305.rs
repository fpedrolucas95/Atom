...
pub fn poly1305_mac(key: &[u8; 32], msg: &[u8]) -> [u8; 16] {
    ...
    while !remaining.is_empty() {
        ...
        let m4 = (u32::from_le_bytes(buf[12..16].try_into().unwrap()) >>  8)
               | ((buf[16] as u32) << 24);
    ...
    let c = h1 >> 26; h1 &= 0x3ff_ffff; h2 = h2.wrapping_add(c);
    let c = h2 >> 26; h2 &= 0x3ff_ffff; h3 = h3.wrapping_add(c);
    let c = h3 >> 26; h3 &= 0x3ff_ffff; h4 = h4.wrapping_add(c);
    let c = h4 >> 26; h4 &= 0x3ff_ffff; h0 = h0.wrapping_add(c * 5);
    let c = h0 >> 26; h0 &= 0x3ff_ffff; h1 = h1.wrapping_add(c);
    ...
    let c = g0 >> 26; g0 &= 0x3ff_ffff;
    let mut g1 = h1.wrapping_add(c);
    let c = g1 >> 26; g1 &= 0x3ff_ffff;
    let mut g2 = h2.wrapping_add(c);
    let c = g2 >> 26; g2 &= 0x3ff_ffff;
    let mut g3 = h3.wrapping_add(c);
    let c = g3 >> 26; g3 &= 0x3ff_ffff;
