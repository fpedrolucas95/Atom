...
// ============================================================================
//
// All UI/graphics functionality runs in USERSPACE, not in the kernel.
// The kernel only provides:
// - Framebuffer info via syscalls (address, dimensions, stride, bpp)
// - Framebuffer mapping to userspace address spaces
// - Minimal panic output for kernel diagnostics
//
// The following functions are NOT provided by the kernel:
// - draw_pixel, draw_char, draw_string (userspace responsibility)
// - fill_rect, clear_screen (userspace responsibility)
// - Window management, compositing (userspace responsibility)
//
// UI functionality is provided by the ui_shell.atxf userspace process.
// ============================================================================
